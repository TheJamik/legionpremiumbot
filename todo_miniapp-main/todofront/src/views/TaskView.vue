    ...
    methods: {
        async fetchTasks() {
            try {
                ...
                const response = await fetch(`${config.API_URL}/tasks/${tg_user.id}`)
        ...
        async createTask() {
            ...
            try {
                const tg_user = window.Telegram.WebApp.initDataUnsafe?.user
                const response = await fetch(`${config.API_URL}/add`, {
                    method: 'POST',
                    headers: {
        ...
        async completeTask(taskId) {
            try {
                const response = await fetch(`${config.API_URL}/completed`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json'
                    },
